...
public class ProgramacaoService {
	...
	public Collection<Programacao> obterLista(Usuario usuario) {
		return (Collection<Programacao>) programacaoRepository.obterLista(usuario.getId(),
				Sort.by(Direction.ASC, "nomeCurso"));
	}
