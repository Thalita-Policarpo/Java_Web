			...
			try {
				...
				while (linha != null) {
					...
					case "AGI": 
						...
						try {
							Agile agile  = new Agile(campos[1], Float.valueOf(campos[2]), Integer. parseInt(campos[3]), campos[4],Integer. parseInt(campos[5]) , Boolean.valueOf(campos[2]));
							curso.add(agile);
					...
					case "BAN": 
						try {
							BancoDeDados bancoDados = new BancoDeDados(campos[1], Float.valueOf(campos[2]), Integer. parseInt(campos[3]), campos[4], Boolean.valueOf(campos[5]),Boolean.valueOf(campos[6]));
					...
					case "PRO": 
						try {
							Programacao programacao = new Programacao(campos[1], Float.valueOf(campos[2]), Integer. parseInt(campos[3]), campos[4], campos[5], Integer. parseInt(campos[6]));
